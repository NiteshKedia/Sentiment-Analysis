# -*- coding: cp1252 -*-
"""
lengthned 0.0.1 - Lengthened Expression Normalizer
 
This module normalizes lengthened english words which have repeating letters.
For example this module converts "cooooooooooooooollllllllllllll" to "cool"
 
This module is based on following paper:
Samuel Brody and Nicholas Diakopoulos. Cooooooooooooooollllllllllllll!!!!!!!!!!!!!! using word
lengthening to detect sentiment in microblogs. In EMNLP2011, pp. 562–570, 2011.
...
Usage:
	import lengthned
	text = lengthned.normalize_word(text) # Normalization for a word
	text = lengthned.normalize_sentence(text) # Normalization for a sentence
"""
import re
